...
#ifndef MamaOeaEntitlementBridgeH__
#define MamaOeaEntitlementBridgeH__
...
extern mama_status 
oeaEntitlement_load (void);

extern mama_status
oeaEntitlement_unload (void);

extern mama_status 
oeaEntitlement_setup (void);

extern mama_status
oeaEntitlement_tearDown (void);
